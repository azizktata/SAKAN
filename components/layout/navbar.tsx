        ...
        >
          ...
          {[
            ...
            <Link
              ...
              className="block px-4 py-2.5 text-sm transition-colors hover:bg-[oklch(32%_0.08_130_/_0.06)]"
          ...
          <div className="border-t mt-1 pt-1" style={{ borderColor: 'var(--color-border)' }}>
            <button
              ...
              className="w-full text-left px-4 py-2.5 text-sm transition-colors hover:bg-[oklch(32%_0.08_130_/_0.06)]"
          ...
          <div className="flex-1 overflow-y-auto px-3 py-4">
            {user && (
              <div className="flex items-center gap-3 px-3 py-3 mb-2 rounded-xl"
                style={{ background: 'oklch(32% 0.08 130 / 0.06)' }}>
                <div className="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center shrink-0"
                  style={{ background: 'oklch(32% 0.08 130 / 0.12)' }}>
                  {user.image ? (
                    // eslint-disable-next-line @next/next/no-img-element
                    <img src={user.image} alt={user.name} className="w-full h-full object-cover" />
                  ) : (
          ...
          <div className="px-4 py-4 border-t space-y-2 shrink-0" style={{ borderColor: 'var(--color-border)' }}>
            ...
            {user && (
              <button
                ...
                style={{ background: 'oklch(52% 0.15 25 / 0.07)', color: 'oklch(42% 0.15 25)' }}
              >
                Déconnexion
              </button>
            )}
